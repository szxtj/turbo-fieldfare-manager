...
<p align="center">
  ...
  <img alt="macOS 26+ / macOS 13+" src="https://img.shields.io/badge/macOS-13.0%2B%20%7C%2026%2B-000000?logo=apple&logoColor=white">
...
| **Operating System** | **macOS 26+ (macOS Sequoia / Darwin 26~27)** | Requires Metal 4 support. Older macOS releases are unsupported by the Metal kernel engine. *(Manager App UI requires macOS 13.0+)* |
...
| **系统版本** | **macOS 26+ (macOS Sequoia / Darwin 26~27)** | 推理引擎深度依赖 **Metal 4**，旧版 macOS 无法编译运行。*(管理工具 UI 兼容 macOS 13.0+)* |
